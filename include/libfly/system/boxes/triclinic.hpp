...
namespace fly::system {
  ...
  public:
     ...
     */
    Triclinic(Arr<Position::scalar_t> const& ex, Arr<bool> const& pd) : m_extents{ex}, m_periodic{pd}, m_inv_extents(1.0 / ex) {
      VERIFY((m_extents > 0).all(), "Triclinic extents are negative");
    }
  ...
  inline Triclinic::Grid Triclinic::make_grid(Position::scalar_t r_cut) const { return {m_extents, r_cut}; }
